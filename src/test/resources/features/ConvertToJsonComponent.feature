Feature: Convert to Json Component WorkFlow Feature
  ...
  Scenario Outline: Create a new Convert to Json Component Workflow and Publish
    ...
    And I enter the label name as <labelName1>
    And I enter the variable name as <variableName1>
    And I enter the default value as <defaultValue1>
    And I enter the placeholder value as <placeholderValue1>
    And I enter the helptext value as <helptextValue>
    And I click on required field button
    And I scroll to Test Input tab and click on it
    And I click on the Save Inputs button
