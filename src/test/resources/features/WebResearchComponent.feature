Feature: Web Research Component WorkFlow Feature
  ...
  @CreateNewWebResearchWorkFlowAndPublish @RegressionTest
  Scenario Outline: Create a new Web Research Component Workflow and Publish
    ...
    Examples:
      ...
      |  |  | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Web Research | Test Automation | Input      | Web Research | 1        | Web Research Test   | Version |  |
