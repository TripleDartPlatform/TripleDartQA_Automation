Feature: Web Research Component WorkFlow Feature

  @CreateNewWebResearchWorkFlowAndPublish
  Scenario Outline: Create a new Web Research Component Workflow and Publish
    ...
    Examples:
      ...
      | "kamesh25491@gmail.com" | "HighPerformance@1" | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Web Research | Test Automation | Input      | Web Research | 1        | Web Research Test   | Version |  |
