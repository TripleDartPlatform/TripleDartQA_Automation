Feature: Text Component WorkFlow Feature
  ...
  @CreateNewTextWorkFlowAndPublish @RegressionTest
  Scenario Outline: Create a new Text Component Workflow and Publish
    ...
    Examples:
      ...
      |  |  | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Text        | Test Automation | Input      | Text         | 1        | Text Test           | Version |  |
