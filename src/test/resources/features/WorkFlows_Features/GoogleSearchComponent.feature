Feature: Google Search Component WorkFlow Feature
  ...
  @CreateNewGoogleSearchWorkFlowAndPublish @RegressionTest
  Scenario Outline: Create a new Google Search Component Workflow and Publish
    ...
    Examples:
      ...
      |  |  | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Google Search | Test Automation | Input      | Google       | 1        | Google Test         | Version |  |
