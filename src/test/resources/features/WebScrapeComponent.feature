Feature: Web Scrape Component WorkFlow Feature

  @CreateNewWebScrapeWorkFlowAndPublish @RegressionTest
  ...
  Examples:
    ...
    |  |  | KeyLBL    | Configure Step | testlbl      | KeyName          | HelpKeyTest   | Web Scrape  | https://app.slatehq.ai/ws/114/workflows | Input      | Web Scrape   | 1        | Web Scrape Test     | Version |  |  |  |  |
