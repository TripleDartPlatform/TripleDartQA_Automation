...
#    Given I login to the slate page with username as <email> and password as <password>
    ...
    Examples:
      ...
      | "kamesh25491@gmail.com" | "HighPerformance@1" | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Find related keywords | Test Automation | Input      | FRK          | 1        | Find related keywords Test | Version |  |
