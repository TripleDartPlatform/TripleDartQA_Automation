Feature: Find Related Keywords Component WorkFlow Feature

  @CreateNewFRKWorkFlowAndPublish @RegressionTest
  Scenario Outline: Create a new Find Related Keywords Component Workflow and Publish
    ...
    Examples:
      ...
      |  |  | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Find related keywords | Test Automation | Input      | FRK          | 1        | Find related keywords Test | Version |  |
