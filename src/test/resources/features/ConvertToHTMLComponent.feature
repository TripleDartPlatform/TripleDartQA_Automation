Feature: Convert to HTML Component WorkFlow Feature

  @CreateNewConvertToHTMLWorkFlowAndPublish
  Scenario Outline: Create a new Text Component Workflow and Publish
#    Given I login to the slate page with username as <email> and password as <password>
    ...
    Examples:
      ...
      | "kamesh25491@gmail.com" | "HighPerformance@1" | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Convert to HTML/Markdown | ConvertToHTML Automation | Input      | ConvertToHTML | 1        | ConvertToHTML Test  | Version |  |
