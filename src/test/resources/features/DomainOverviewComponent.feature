Feature: Domain Overview Component WorkFlow Feature

  @CreateNewDomainOverviewWorkFlowAndPublish
  Scenario Outline: Create a new Domain Overview Component Workflow and Publish
#    Given I login to the slate page with username as <email> and password as <password>
    ...
    Examples:
      ...
      | "kamesh25491@gmail.com" | "HighPerformance@1" | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Domain Overview | Test Automation | Input      | Domain Overview | 1        | Domain Overview Test | Version |  |
