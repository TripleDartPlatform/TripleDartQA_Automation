Feature: Text Component WorkFlow Feature

  @CreateNewTextWorkFlowAndPublish
...
#    Given I login to the slate page with username as <email> and password as <password>
    ...
    Examples:
      ...
      | "kamesh25491@gmail.com" | "HighPerformance@1" | TestLBL   | Configure Step | testlbl      | PlaceHolderName  | HelpTest      | Text        | Test Automation | Input      | Text         | 1        | Text Test           | Version |  |
